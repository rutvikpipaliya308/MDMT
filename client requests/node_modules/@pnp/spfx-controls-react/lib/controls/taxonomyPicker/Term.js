...
var Term = (function (_super) {
    ...
    function Term(props) {
        ...
        _this.termActionCallback = function (updateAction) {
            ...
            else if (updateAction.updateActionType === termActions_1.UpdateType.hideTerm) {
                _this.setState({
                    hidden: updateAction.value
                });
            }
            else if (updateAction.updateActionType === termActions_1.UpdateType.disableTerm) {
                _this.setState({
                    disabled: updateAction.value
                });
            }
            else if (updateAction.updateActionType === termActions_1.UpdateType.selectTerm) {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: TaxonomyPicker_module_scss_1.default.listItem + " " + TaxonomyPicker_module_scss_1.default.term, style: styleProps },
                React.createElement("div", null,
                    React.createElement(Checkbox_1.Checkbox, { checked: this.state.selected, style: checkBoxStyle, disabled: this.props.term.IsDeprecated || !this.props.term.IsAvailableForTagging || this.props.disabled || this.state.disabled, className: this.getClassName(), label: this.state.termLabel, onChange: this._handleChange })),
