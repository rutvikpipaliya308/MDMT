...
var TermActionsControl = (function (_super) {
    ...
    TermActionsControl.prototype.render = function () {
        ...
        return (React.createElement("div", null, displayMode == ITermsActions_1.TermActionsDisplayMode.dropdown ?
            React.createElement(DropdownTermAction_1.DropdownTermAction, { key: "DdAction-" + term.Id, termActions: availableActions, term: term, displayStyle: displayStyle, termActionCallback: this.props.termActionCallback, spTermService: this.props.spTermService, termActionChanges: termActionChanges })
            :
                React.createElement(ButtonTermAction_1.default, { key: "BtnAction-" + term.Id, termActions: availableActions, term: term, displayStyle: displayStyle, termActionCallback: this.props.termActionCallback, spTermService: this.props.spTermService, termActionChanges: termActionChanges })));
    };
