    ...
    FieldErrorMessage.prototype.render = function () {
        if (this.props.errorMessage !== undefined && this.props.errorMessage !== null && this.props.errorMessage !== '') {
            return (React.createElement("div", { "aria-live": "assertive" },
                React.createElement("p", { className: "ms-TextField-errorMessage " + TaxonomyPicker_module_scss_1.default.errorMessage },
                    React.createElement(Icon_1.Icon, { iconName: 'Error', className: TaxonomyPicker_module_scss_1.default.errorIcon }),
