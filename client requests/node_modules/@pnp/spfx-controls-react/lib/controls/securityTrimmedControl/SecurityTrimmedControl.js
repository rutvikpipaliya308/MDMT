...
var SecurityTrimmedControl = (function (_super) {
    ...
    SecurityTrimmedControl.prototype.checkPermissions = function () {
        ...
        if (level === _1.PermissionLevel.currentWeb || level === _1.PermissionLevel.currentList) {
            // Get the permission scope
            var permissions = (level === _1.PermissionLevel.currentWeb ? context.pageContext.web : context.pageContext.list).permissions;
        ...
        else if (level === _1.PermissionLevel.remoteWeb) {
            // Check permissions on remote site
            this.checkRemoteSitePermissions();
        }
        else if (level === _1.PermissionLevel.remoteListOrLib) {
            // Check permissions on remote list/library
            this.checkRemoteListOrLibPermissions();
        }
        else if (level === _1.PermissionLevel.remoteListItem) {
            this.checkRemoteListItem();
        }
        else if (level === _1.PermissionLevel.remoteFolder) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, context.spHttpClient.get(apiUrl, sp_http_1.SPHttpClient.configurations.v1).then(function (data) { return data.json(); })];
                    case 2:
                        result = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, context.spHttpClient.get(apiUrl, sp_http_1.SPHttpClient.configurations.v1)];
                    case 1:
                        data = _b.sent();
                    ...
                    case 2:
                        ...
                        if (typeof result.High !== "undefined" && typeof result.Low !== "undefined") {
                            permission = new sp_page_context_1.SPPermission(result);
...
exports.SecurityTrimmedControl = SecurityTrimmedControl;
