...
var GridLayout_module_scss_1 = require("./GridLayout.module.scss");
...
var ROWS_PER_PAGE = +GridLayout_module_scss_1.default.rowsPerPage;
var MAX_ROW_HEIGHT = +GridLayout_module_scss_1.default.maxWidth;
var PADDING = +GridLayout_module_scss_1.default.padding;
var MIN_WIDTH = +GridLayout_module_scss_1.default.minWidth;
var COMPACT_THRESHOLD = +GridLayout_module_scss_1.default.compactThreshold;
/**
    ...
    GridLayout.prototype.render = function () {
        return (React.createElement("div", { className: GridLayout_module_scss_1.default.gridLayout, role: "group", "aria-label": this.props.ariaLabel },
            React.createElement(FocusZone_1.FocusZone, null,
                React.createElement(List_1.List, __assign({ role: "presentation", className: GridLayout_module_scss_1.default.gridLayoutList, items: this.props.items, getItemCountForPage: this._getItemCountForPage, getPageHeight: this._getPageHeight, onRenderCell: this._onRenderCell }, this.props.listProps)))));
    };
    return GridLayout;
}(React.Component));
