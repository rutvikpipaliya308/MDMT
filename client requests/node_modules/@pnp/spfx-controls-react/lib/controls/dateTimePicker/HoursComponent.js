...
var HoursComponent = (function (_super) {
    ...
    HoursComponent.prototype.render = function () {
        ...
        if (renderDropdown) {
            return (React.createElement(Dropdown_1.Dropdown, { disabled: this.props.disabled, label: '', options: this._hours, onChanged: function (option) {
                    onChange(option.text);
                }, dropdownWidth: 110 }));
        }
        else {
            return (React.createElement(TextField_1.MaskedTextField, { disabled: disabled, label: "", value: value ? TimeHelper_1.TimeHelper.hoursValue(value, timeConvention) : "" + (timeConvention === DateTimeConventions_1.TimeConvention.Hours24 ? "00" : "12 AM"), mask: timeConvention === DateTimeConventions_1.TimeConvention.Hours24 ? "29" : "19 AM", maskFormat: {
                    '1': /[0-1]/,
                    '2': /[0-2]/,
                    '9': /[0-9]/,
                    'A': /[AaPp]/,
