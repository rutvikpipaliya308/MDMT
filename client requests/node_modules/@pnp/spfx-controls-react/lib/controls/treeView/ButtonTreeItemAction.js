 ...
 */
var ButtonTreeItemAction = (function (_super) {
        ...
        return (React.createElement("div", null, treeItemActions &&
            treeItemActions.map(function (treeItemAction) {
                ...
                return (treeItemAction.hidden ? (null) : (React.createElement("div", null,
                    React.createElement(Button_1.CommandBarButton, { split: true, onClick: function () { _this.onActionExecute(treeItemAction); }, iconProps: iconProps, text: text, title: btnTitle, name: name, key: treeItem.key, className: TreeView_module_scss_1.default.actionButton }))));
            })));
    };
    return ButtonTreeItemAction;
}(React.Component));
exports.default = ButtonTreeItemAction;
