 ...
 */
var DropdownTreeItemAction = (function (_super) {
            ...
            var _loop_1 = function (treeItemAction) {
                if (!treeItemAction.hidden) {
                    var treeItemActionMenuItem = {
                        ...
                        onClick: function () { _this.onActionExecute(treeItemAction); }
                    };
     ...
     */
    DropdownTreeItemAction.prototype.componentWillMount = function () {
    ...
    DropdownTreeItemAction.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Button_1.IconButton, { menuProps: contextualMenuProps, menuIconProps: { iconName: 'MoreVertical' }, className: TreeView_module_scss_1.default.actionMore, title: "More", ariaLabel: "More" })));
    };
