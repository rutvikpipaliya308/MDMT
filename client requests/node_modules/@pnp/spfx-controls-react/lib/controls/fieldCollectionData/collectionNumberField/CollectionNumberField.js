...
var CollectionNumberField = (function (_super) {
    ...
    CollectionNumberField.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "FieldCollectionData__panel__number-field " + FieldCollectionData_module_scss_1.default.numberField + " " + (this.state.errorMessage ? FieldCollectionData_module_scss_1.default.invalidField : "") },
