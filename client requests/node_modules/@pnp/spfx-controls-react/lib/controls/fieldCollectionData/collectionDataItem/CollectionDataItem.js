...
var CollectionDataItem = (function (_super) {
    ...
    */
    ...
    CollectionDataItem.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "PropertyFieldCollectionData__panel__table-row " + FieldCollectionData_module_scss_1.default.tableRow + " " + (this.props.index === null ? FieldCollectionData_module_scss_1.default.tableFooter : "") },
            (this.props.sortingEnabled && this.props.totalItems) && (React.createElement("span", { className: "PropertyFieldCollectionData__panel__sorting-field " + FieldCollectionData_module_scss_1.default.tableCell },
            ...
            (this.props.sortingEnabled && this.props.totalItems === null) && (React.createElement("span", { className: "" + FieldCollectionData_module_scss_1.default.tableCell })),
            this.props.fields.map(function (f) { return (React.createElement("span", { key: "dataitem-" + f.id, className: FieldCollectionData_module_scss_1.default.tableCell + " " + FieldCollectionData_module_scss_1.default.inputField }, _this.renderField(f, crntItem))); }),
            React.createElement("span", { className: FieldCollectionData_module_scss_1.default.tableCell },
                React.createElement("span", { ref: function (ref) { return _this.calloutCellRef = ref; } },
                    React.createElement(Link_1.Link, { title: strings.CollectionDataItemShowErrorsLabel, className: FieldCollectionData_module_scss_1.default.errorCalloutLink, disabled: !this.state.errorMsgs || this.state.errorMsgs.length === 0, onClick: this.toggleErrorCallout },
                        React.createElement(Icon_1.Icon, { iconName: "Error" }))),
                this.state.showCallout && (React.createElement(Callout_1.Callout, { className: FieldCollectionData_module_scss_1.default.errorCallout, target: this.calloutCellRef, isBeakVisible: true, directionalHint: 4 /* bottomLeftEdge */, directionalHintForRTL: 13 /* rightBottomEdge */, onDismiss: this.hideErrorCallout }, (this.state.errorMsgs && this.state.errorMsgs.length > 0) && (React.createElement("div", { className: FieldCollectionData_module_scss_1.default.errorMsgs },
            ...
            this.props.index !== null ? (React.createElement(Link_1.Link, { title: strings.CollectionDeleteRowButtonLabel, disabled: !this.props.fDeleteItem || this.props.disableItemDeletion, onClick: this.deleteRow },
                React.createElement(Icon_1.Icon, { iconName: "Clear" }))) : (React.createElement(Link_1.Link, { title: strings.CollectionAddRowButtonLabel, className: "" + (this.disableAdd(crntItem) ? "" : FieldCollectionData_module_scss_1.default.addBtn), disabled: this.disableAdd(crntItem), onClick: this.addRow },
