...
export declare class FieldUserRenderer extends React.Component<IFieldUserRendererProps, IFieldUserRendererState> {
     ...
     * @param user IUser
     */
    private _onRenderCompactCard(index, user);
    /**
     * Renders expanded part of user Hover Card
     * @param user IUser
     */
    private _onRenderExpandedCard(user);
    /**
     ...
     */
    private _getUserFromPrincipalAndProps(principal, userProfileProperties);
    /**
     ...
     */
    private _requestUserProfile(user, index);
}
