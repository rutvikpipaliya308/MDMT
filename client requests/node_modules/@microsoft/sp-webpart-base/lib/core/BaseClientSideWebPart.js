...
var BaseClientSideWebPart =  (function (_super) {
    ...
    BaseClientSideWebPart.prototype._resolveOrRejectOnRenderPromise = function (isReject) {
        ...
        if (!KillSwitches.isLogWebPartLoadRenderDoneKillSwitchActivated() && isReject) {
            if (this._renderPromiseRejecter) {
                this._renderPromiseRejecter(new Error(Text.format('WebPart alias={0} is render timeout.', this.context.manifest.alias)));
            }
        }
        else {
            if (this._renderPromiseResolver) {
    ...
    BaseClientSideWebPart.prototype._isSPDPaintStarvationFixKillSwitchActivated = function () {
        return _SPKillSwitch.isActivated(Guid.parse('c63a9c71-8035-47c6-b57b-09d203db6b6a'), '01/24/2019', 'Fix paint starvation problem for SPD');
    };
