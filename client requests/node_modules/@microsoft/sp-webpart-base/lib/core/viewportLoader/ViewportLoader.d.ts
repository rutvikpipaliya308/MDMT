...
export default class ViewportLoader {
    ...
    /**
     * There are features which loads IntersectionObserver pollyfill in lazy manner.
     ...
     */
    static isInInitialViewport(webpart: IViewportAwareWebPart): boolean;
     ...
     * @param webPart
     */
    release(webPart: IViewportAwareWebPart): boolean;
    /**
...
//# sourceMappingURL=ViewportLoader.d.ts.map