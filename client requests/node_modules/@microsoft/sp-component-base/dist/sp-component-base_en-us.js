...
/******/ 		return __webpack_require__.p + "" + chunkId + "." + ({}[chunkId]||chunkId) + "_" + {"0":"70210f217df3934d29ea"}[chunkId] + ".js"
/******/ 	}
/******/
/******/ 	// The require function
/******/ 	function __webpack_require__(moduleId) {
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_467dc675_7cc5_4709_8aac_78e3b71bd2f6_1_9_1"] = window["webpackJsonp_467dc675_7cc5_4709_8aac_78e3b71bd2f6_1_9_1"] || [];
...
/* harmony import */ var _DynamicDataProvider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DynamicDataProvider */ "./lib/DynamicDataProvider.js");
/* harmony import */ var _DynamicDataSourceManager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DynamicDataSourceManager */ "./lib/DynamicDataSourceManager.js");
...
var BaseComponentContext =  (function () {
    function BaseComponentContext(parameters) {
        ...
        this._graphHttpClient = this.serviceScope.createDefaultAndProvide(_microsoft_sp_http__WEBPACK_IMPORTED_MODULE_3__["GraphHttpClient"].serviceKey);
...
/* harmony import */ var _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @microsoft/sp-diagnostics */ "@microsoft/sp-diagnostics");
/* harmony import */ var _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _microsoft_sp_dynamic_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @microsoft/sp-dynamic-data */ "@microsoft/sp-dynamic-data");
...
/* harmony import */ var _common_KillSwitches__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./common/KillSwitches */ "./lib/common/KillSwitches.js");
...
var DynamicDataProvider =  (function () {
    ...
    DynamicDataProvider.prototype._initialize = function (component, serviceScope) {
        ...
        this._dynamicDataManager = serviceScope.consume(_microsoft_sp_dynamic_data__WEBPACK_IMPORTED_MODULE_2__["_DynamicDataManager"].serviceKey);
...
/* harmony import */ var _microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _common_KillSwitches__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./common/KillSwitches */ "./lib/common/KillSwitches.js");
/* harmony import */ var _DynamicDataProvider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DynamicDataProvider */ "./lib/DynamicDataProvider.js");
/* harmony import */ var _loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./loc/Strings.resx */ "./lib/loc/Strings.resx.js");
...
var DynamicDataSourceManager =  (function () {
    ...
    DynamicDataSourceManager.prototype.updateMetadata = function (metadata) {
        ...
        Object(_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_3__["merge"])(this._source.metadata, metadata);
    };
    ...
    DynamicDataSourceManager.prototype._assertValidEvent = function (eventName) {
        if (!this._allowedEvents() ||
            ...
            throw new Error(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["Text"].format(_loc_Strings_resx__WEBPACK_IMPORTED_MODULE_6__["default"].InvalidEvent, eventName, this._source.metadata.title));
        }
    };
...
/* harmony import */ var _microsoft_sp_dynamic_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @microsoft/sp-dynamic-data */ "@microsoft/sp-dynamic-data");
/* harmony import */ var _microsoft_sp_dynamic_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_microsoft_sp_dynamic_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _DynamicDataProvider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DynamicDataProvider */ "./lib/DynamicDataProvider.js");
...
var LegacyThirdPartyFabricCoreLoader =  (function () {
    ...
    LegacyThirdPartyFabricCoreLoader.load = function (isComponentInternal) {
        if (!isComponentInternal && !LegacyThirdPartyFabricCoreLoader.isLoaded) {
            return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./chunks/legacy-third-party-fabric-core/index */ "./lib/chunks/legacy-third-party-fabric-core/index.js")).then(function () {
    ...
    LegacyThirdPartyFabricCoreLoader._shouldLoad = function (manifest) {
        ...
        if (manifest.loadLegacyFabricCss === undefined) {
            ...
            if (resource && resource.version) {
                var version = _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__["Version"].parse(resource.version);
...
/*!**********************!*\
  !*** ./lib/index.js ***!
  \**********************/
/*! exports provided: BaseComponent, BaseComponentContext, DynamicDataProvider, DynamicDataSourceManager, DynamicProperty, _LegacyThirdPartyFabricCoreLoader, ThemeChangedEventArgs, ThemeProvider, _ComponentBaseKillSwitches */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _BaseComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseComponent */ "./lib/BaseComponent.js");
...
/* harmony import */ var _BaseComponentContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BaseComponentContext */ "./lib/BaseComponentContext.js");
...
/* harmony import */ var _DynamicDataProvider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DynamicDataProvider */ "./lib/DynamicDataProvider.js");
...
/* harmony import */ var _DynamicDataSourceManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DynamicDataSourceManager */ "./lib/DynamicDataSourceManager.js");
...
/* harmony import */ var _DynamicProperty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DynamicProperty */ "./lib/DynamicProperty.js");
...
/* harmony import */ var _LegacyThirdPartyFabricCoreLoader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LegacyThirdPartyFabricCoreLoader */ "./lib/LegacyThirdPartyFabricCoreLoader.js");
...
/* harmony import */ var _themeProvider_ThemeProvider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./themeProvider/ThemeProvider */ "./lib/themeProvider/ThemeProvider.js");
...
/* harmony import */ var _common_KillSwitches__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./common/KillSwitches */ "./lib/common/KillSwitches.js");
