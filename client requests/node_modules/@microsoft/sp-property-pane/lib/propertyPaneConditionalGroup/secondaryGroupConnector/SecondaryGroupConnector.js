...
var SecondaryGroupConnector =  (function (_super) {
    ...
    SecondaryGroupConnector.prototype.render = function () {
        ...
        var secondaryConnectorClassName = css(styles.alternateFieldsConnector, (!KillSwitches.isFixEllipsisGoneInMacKillSwitchActivated()
            && _BrowserDetection.getBrowserInformation().os === 4 ) ? styles.mac_only : '');
