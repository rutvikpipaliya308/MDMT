...
var PropertyPane =  (function (_super) {
    ...
    function PropertyPane(props) {
        ...
        if (!KillSwitches.isDebounceRaiseEventKillSwitchActivated()) {
            _this._raiseEvent = debounce(_this._raiseEvent, DELAY_RAISE_EVENT_IN_MILLISECONDS, {
                leading: true,
                trailing: true
            });
        }
    ...
    PropertyPane.prototype._renderNoConfigurationState = function () {
        return (React.createElement("div", null,
            ...
            React.createElement("div", { role: 'alert', "aria-live": 'polite', className: propertyPaneStyles.propertyPaneDescription, "data-automation-id": 'noConfigurationPropertyPane' }, Strings.PropertyPaneEmptyStateDescription)));
    };
