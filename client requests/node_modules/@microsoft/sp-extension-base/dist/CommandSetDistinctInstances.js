var CommandSetDistinctInstances =  (function () {
    ...
    CommandSetDistinctInstances.prototype.TestRun = function () {
        ...
        TAB.AddTask(TAB.MakeTask(function () {
            SPTaskLib.ClientFeatures.SetOverrideFeature(802, false); 
            SPTaskLib.ClientFeatures.SetOverrideFeature(851, false); 
            SPTaskLib.ClientFeatures.SetOverrideFeature(858, false); 
        }), SPTaskLib.CommandBar.WaitForCommandBar({ area: 'primary' }));
        TAB.AddTask(TAB.MakeTask(function () {
            var cb = new SPTaskLib.CommandBar({ area: 'primary' });
        ...
        SPTaskLib.CommandBar.AddItemVerificationTask({
            area: 'primary',
            expectedItems: [
                { title: 'Command One' },
                { title: 'Command Two' },
        ...
        TAB.AddTask(TAB.MakeTask(function () {
            var commandBar = new SPTaskLib.CommandBar({ area: 'primary' });
