define("0773bd53-a69e-4293-87e6-ba80ea4d614b_1.9.1", ["@microsoft/decorators","@microsoft/sp-component-base","@microsoft/sp-core-library","@microsoft/sp-diagnostics","@microsoft/sp-loader","@ms/sp-telemetry","resx-strings"], function(__WEBPACK_EXTERNAL_MODULE__microsoft_decorators__, __WEBPACK_EXTERNAL_MODULE__microsoft_sp_component_base__, __WEBPACK_EXTERNAL_MODULE__microsoft_sp_core_library__, __WEBPACK_EXTERNAL_MODULE__microsoft_sp_diagnostics__, __WEBPACK_EXTERNAL_MODULE__microsoft_sp_loader__, __WEBPACK_EXTERNAL_MODULE__ms_sp_telemetry__, __WEBPACK_EXTERNAL_MODULE_resx_strings__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var _microsoft_sp_component_base__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @microsoft/sp-component-base */ "@microsoft/sp-component-base");
...
/* harmony import */ var _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ms/sp-telemetry */ "@ms/sp-telemetry");
...
/* harmony import */ var _BaseExtension__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BaseExtension */ "./lib/BaseExtension.js");
/* harmony import */ var _ExtensionStrings_resx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ExtensionStrings.resx */ "./lib/ExtensionStrings.resx.js");
...
var ExtensionManager =  (function () {
    ...
    ExtensionManager.prototype.createExtension = function (componentId, propertiesJson, contextCreator) {
        ...
        _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__["_PerformanceLogger"].startMarkForComponent(perfLogKeyCreate);
        var error = undefined;
        var extraData = this._createQosExtraData(manifest);
        try {
            _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__["_PerformanceLogger"].startMarkForComponent(perfLogKeyScriptLoad);
            var createPromise = _microsoft_sp_loader__WEBPACK_IMPORTED_MODULE_3__["SPComponentLoader"].loadComponent(manifest).then(function (component) {
                _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__["_PerformanceLogger"].endMarkForComponent(perfLogKeyScriptLoad);
                _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__["_PerformanceLogger"].logPerformanceMetricToConsole(perfLogKeyScriptLoad, 'Extension.ScriptLoad', manifest.id, manifest.alias);
                ...
                if (!(extension instanceof _BaseExtension__WEBPACK_IMPORTED_MODULE_5__["default"])) {
                    error = new Error(_ExtensionStrings_resx__WEBPACK_IMPORTED_MODULE_6__["default"].expectingBaseExtension);
                    qosMonitor.writeExpectedFailure('DoesNotExtendBaseExtension', error, extraData);
                    throw error;
                }
                if (!(extension instanceof _this._expectedType)) {
                    error = Error(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["Text"].format(_ExtensionStrings_resx__WEBPACK_IMPORTED_MODULE_6__["default"].wrongExtensionType, _this._expectedType));
                ...
                return extension._init(context, propertiesJson).then(function () {
                    ...
                    error = new Error(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["Text"].format(_ExtensionStrings_resx__WEBPACK_IMPORTED_MODULE_6__["default"].extensionInitFailure, componentId));
                    qosMonitor.writeExpectedFailure('ExtensionInitFailure', error, extraData);
                    throw error;
                });
            }, function (e) {
                if (!error) {
                    error = new Error(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_1__["Text"].format(_ExtensionStrings_resx__WEBPACK_IMPORTED_MODULE_6__["default"].extensionLoadFailure, componentId));
                    qosMonitor.writeExpectedFailure('ExtensionLoadFailure', error, extraData);
                }
                throw error;
            }).then(function (extension) {
                qosMonitor.writeSuccess(extraData);
                _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__["_PerformanceLogger"].endMarkForComponent(perfLogKeyCreate);
                _ms_sp_telemetry__WEBPACK_IMPORTED_MODULE_4__["_PerformanceLogger"].logPerformanceMetricToConsole(perfLogKeyScriptLoad, 'Extension.Create', manifest.id, manifest.alias);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _BaseExtension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseExtension */ "./lib/BaseExtension.js");
...
/* harmony import */ var _ExtensionContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExtensionContext */ "./lib/ExtensionContext.js");
...
/* harmony import */ var _ExtensionManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ExtensionManager */ "./lib/ExtensionManager.js");
