...
class VersionControl {
    ...
    static getChangedFiles(targetBranch, skipFetch = false, pathPrefix) {
        ...
        const regex = pathPrefix ? new RegExp(`^${pathPrefix}`, 'i') : undefined;
        return output.split('\n').map((line) => {
            if (line) {
    ...
    static getRemoteMasterBranch(repositoryUrl) {
        ...
        if (matchingRemotes.length > 0) {
            ...
            console.log(colors.yellow(`Unable to find a git remote matching the repository URL (${matchingRemotes[0]}). ` +
    ...
    static _fetchNonDefaultBranch(remoteBranchName) {
