...
class Utilities {
    ...
    static _executeLifecycleCommandInternal(command, spawnFunction, options) {
        ...
        const environment = Utilities._createEnvironmentForRushCommand({
            ...
            pathOptions: Object.assign({}, options.environmentPathOptions, { projectRoot: options.workingDirectory, commonTempFolder: options.rushConfiguration ? options.rushConfiguration.commonTempFolder : undefined })
        });
    ...
    static _executeCommandInternal(command, args, workingDirectory, stdio, environment, keepEnvironment = false) {
        ...
        const escapedCommand = command.indexOf(' ') < 0
            ? command
        ...
        if (result.error && result.error.errno === 'ENOENT') { // tslint:disable-line:no-any
