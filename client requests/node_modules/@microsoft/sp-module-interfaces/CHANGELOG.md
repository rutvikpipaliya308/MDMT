...
- Add an internal manifest field to ClientSideWebPart manifest
- Upgrate TypeScript to 3.3
- Update clent-side-web-part schema to include useFallbackWhenPropertiesUpdatedExternally flag
