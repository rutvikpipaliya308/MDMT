...
import { BaseClientSideWebPart, PropertyPaneDropdown, PropertyPaneTextField } from '@microsoft/sp-webpart-base';
...
var ClientRequestsWebPart = /** @class */ (function (_super) {
    __extends(ClientRequestsWebPart, _super);
    function ClientRequestsWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ClientRequestsWebPart.prototype.render = function () {
        var element = React.createElement(ClientRequests, {
    ...
    ClientRequestsWebPart.prototype.onDispose = function () {
        ReactDom.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(ClientRequestsWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    ClientRequestsWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
    ...
    ClientRequestsWebPart.prototype.onPropertyPaneFieldChanged = function (propertyPath, oldValue, newValue) {
    ...
    return ClientRequestsWebPart;
}(BaseClientSideWebPart));
export default ClientRequestsWebPart;
//# sourceMappingURL=ClientRequestsWebPart.js.map