...
var Request13 = /** @class */ (function (_super) {
    __extends(Request13, _super);
    function Request13(props) {
    ...
    Request13.prototype.componentWillMount = function () {
    ...
    Request13.prototype.getEditableFields = function (item) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Request13.prototype.render = function () {
        var _this = this;
                        ...
                        :
                            React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "container-xl" },
                                    React.createElement("ul", { className: "row no-gutters process-block mb-5" }, Constants.CLIENTCREATIONWITHCURRENCY_SECTION.map(function (item, i) { return (React.createElement("li", { key: i, className: i === (_this.state.currentStep - 1) ? Constants.CLSCOLACTIVE : _this.state.currentStep > i ? Constants.CLSCOLSAVE : Constants.CLSCOL },
    ...
    Request13.prototype.RenderSections = function (step) {
        ...
        switch (step) {
            case 1:
                return React.createElement(Section1, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section1Data, dataChange: this.dataChange.bind(this), nextStep: this.NextStep.bind(this), itemSubmitted: this.state.itemSubmitted, listOfEditableFields: listOfEditableFields, accessLevel: this.state.accessLevel }));
            case 2:
                return React.createElement(Section2, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section2Data, approvalData: this.state.approvalData, dataChange: this.dataChange.bind(this), selectedClient: this.state.approvalData.maconomyAccountID, nextStep: this.NextStep.bind(this), backStep: this.BackStep.bind(this), selectedClientData: this.state.section1Data.updateRequestDataArray, listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
            case 3:
    ...
    Request13.prototype.BackStep = function () {
...
//# sourceMappingURL=Request13.js.map