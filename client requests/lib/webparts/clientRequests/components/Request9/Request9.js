...
var Request9 = /** @class */ (function (_super) {
    __extends(Request9, _super);
    function Request9(props) {
    ...
    Request9.prototype.componentWillMount = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, tempUserAccessLevel.length];
                    case 5:
                        isAccessLevelExists = (_a.sent()) > 0 ? true : false;
                    ...
                    case 6:
                        ...
                        if (!(hasAddPermission && isAccessLevelExists)) return [3 /*break*/, 11];
                        ...
                        if (!!isNaN(id_1)) return [3 /*break*/, 10];
                    ...
                    case 7:
                        ...
                        item = tempArray_1[0];
                        if (!(item !== null && item !== undefined)) return [3 /*break*/, 9];
    ...
    Request9.prototype.getEditableFields = function (item) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Request9.prototype.render = function () {
        var _this = this;
                        ...
                        :
                            React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "container-xl" },
                                    React.createElement("ul", { className: "row no-gutters process-block mb-5" }, Constants.REQ9_SECTION_OPTIONS.map(function (item, i) { return (React.createElement("li", { key: i, className: i === (_this.state.currentStep - 1) ? Constants.CLSCOLACTIVE : _this.state.currentStep > i ? Constants.CLSCOLSAVE : Constants.CLSCOL },
    ...
    Request9.prototype.BackStep = function () {
    ...
    Request9.prototype.RenderSections = function (step) {
        ...
        switch (step) {
            ...
            case 3:
                return React.createElement(ParentClientCommonSection, __assign({}, this.props, { itemID: this.state.itemID, listData: this.state.listData, data: this.state.commonSectionData, dataChange: this.dataChange.bind(this), approvalData: this.state.approvalData, backStep: this.BackStep.bind(this), itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
        }
    };
    return Request9;
}(React.Component));
export default Request9;
//# sourceMappingURL=Request9.js.map