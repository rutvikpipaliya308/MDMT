...
var Section1 = /** @class */ (function (_super) {
        ...
        return (React.createElement("div", { className: "container-fluid" },
            React.createElement("div", { className: "card-primary card-responsible text-center d-table w-auto m-auto", style: { position: "relative" } },
                ...
                React.createElement("div", { className: "card-body" },
                    React.createElement(CompanySection, __assign({ ref: this.companySectionRef, isDisable: this.checkIfFieldDisabled("dpCompany") }, this.props, { dpCompany: this.state.dpCompany, setLoader: this.SetLoader.bind(this), isWorkflowTypeNeeded: false, requestType: strings.RequestType[2], accessLevel: this.props.accessLevel }))),
    ...
    Section1.prototype.SaveData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var accessLevel, companyNumber, tempData, queryParameters, id, currentUSerID, recordSaved, body, tempBody, error_1, errordata;
            var _this = this;
