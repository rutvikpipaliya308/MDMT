...
var Request11 = /** @class */ (function (_super) {
    __extends(Request11, _super);
    function Request11(props) {
    ...
    Request11.prototype.componentWillMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var hasAddPermission, currentUserId, currentUPN, tempUserAccessLevel, isAccessLevelExists, tempAccessLevel, queryParameters, id_1, viewXML, tempData, tempArray_1, item, hasItemEditPermission;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        tempAccessLevel = "";
                        if (!(hasAddPermission && isAccessLevelExists)) return [3 /*break*/, 9];
                        ...
                        if (!queryParameters.getValue("itemID")) return [3 /*break*/, 8];
                        id_1 = parseInt(queryParameters.getValue("itemID"));
                        if (!!isNaN(id_1)) return [3 /*break*/, 8];
                    ...
                    case 5:
                        ...
                        item = tempArray_1[0];
                        if (!(item !== null && item !== undefined)) return [3 /*break*/, 7];
    ...
    Request11.prototype.render = function () {
        var _this = this;
                        ...
                        :
                            React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "container-xl" },
                                    React.createElement("ul", { className: "row no-gutters process-block mb-5" }, Constants.REQ11_SECTION_OPTIONS.map(function (item, i) { return (React.createElement("li", { key: i, className: i === (_this.state.currentStep - 1) ? Constants.CLSCOLACTIVE : _this.state.currentStep > i ? Constants.CLSCOLSAVE : Constants.CLSCOL },
    ...
    Request11.prototype.RenderSections = function (step) {
        ...
        switch (step) {
            case 1:
                return React.createElement(Section1, __assign({}, this.props, { itemID: this.state.itemID, listData: this.state.listData, data: this.state.section1Data, dataChange: this.dataChange.bind(this), nextStep: this.NextStep.bind(this), itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
            case 2:
    ...
    Request11.prototype.BackStep = function () {
...
export default Request11;
//# sourceMappingURL=Request11.js.map