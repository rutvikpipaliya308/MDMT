...
var Request7 = /** @class */ (function (_super) {
    __extends(Request7, _super);
    function Request7(props) {
    ...
    Request7.prototype.componentWillMount = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        ...
                        this.setState({ invalidPermission: true });
                        _a.label = 11;
                    case 11: return [4 /*yield*/, this.getDueDiligenceQuestions()];
                    case 12:
                        _a.sent();
    ...
    Request7.prototype.getEditableFields = function (item) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Request7.prototype.render = function () {
        var _this = this;
                        ...
                        :
                            React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "container-xl" },
                                    React.createElement("ul", { className: "row no-gutters process-block mb-5" }, Constants.REQ7_SECTION_OPTIONS.map(function (item, i) { return (React.createElement("li", { key: i, className: i === (_this.state.currentStep - 1) ? Constants.CLSCOLACTIVE : _this.state.currentStep > i ? Constants.CLSCOLSAVE : Constants.CLSCOL },
    ...
    Request7.prototype.RenderSections = function (step) {
        ...
        switch (step) {
            case 1:
                return React.createElement(Section1, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section1Data, dataChange: this.dataChange.bind(this), nextStep: this.NextStep.bind(this), listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
            case 2:
    ...
    Request7.prototype.BackStep = function () {
...
export default Request7;
//# sourceMappingURL=Request7.js.map