...
import Section3 from '../Request7/Section3/Section3';
import Section4 from '../Request7/Section4/Section4';
import Attachments from '../common/Attachments/Attachments';
import DueDiligence from '../common/DueDiligence/DueDiligence';
var listOfEditableFields = [
    ...
    { key: "tbxLegalNameInArabic", value: strings.Lbl_LegalNameInArabic, openable: true },
    { key: "tbxArabicLine1", value: strings.Lbl_ArabicLine1, openable: true },
    { key: "tbxArabicLine2", value: strings.Lbl_ArabicLine2, openable: true },
    // { key: "tbxArabicZipcode", value: strings.Lbl_ArabicZipCode, openable: true },
    { key: "tbxArabicPostal", value: strings.Lbl_ArabicPostal, openable: true },
    { key: "tbxArabicCountryArea", value: strings.Lbl_ArabicCountryArea, openable: true },
...
var Request8 = /** @class */ (function (_super) {
    __extends(Request8, _super);
    function Request8(props) {
        ...
        _this.state = {
            ...
            itemSubmitted: false,
            isFHDUser: false,
            countryOfCompany: '' // rutcik 13-3-2024
        };
        return _this;
    }
    Request8.prototype.componentWillMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var hasAddPermission, currentUserId, currentUPN, tempUserAccessLevel, isAccessLevelExists, tempAccessLevel, FHDUser, isCurrentFHDUser, queryParameters, id_1, viewXML, tempData, tempArray_1, item, hasItemEditPermission, companyNo_1, tempData, tempArray_2, item;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        if (!(hasAddPermission && isAccessLevelExists)) return [3 /*break*/, 13];
                        ...
                        if (!queryParameters.getValue("itemID")) return [3 /*break*/, 10];
                    ...
                    case 10:
                        if (!queryParameters.getValue("companyNo")) return [3 /*break*/, 12];
                        companyNo_1 = queryParameters.getValue("companyNo");
                        if (!(companyNo_1)) return [3 /*break*/, 12];
                        ...
                        tempData.filter(function (tempItem) {
                            ...
                            if (tempItem.AccessLevel === tempAccessLevel) {
                                ...
                                if (tempItem["AccessLevel"] !== null && tempAccessLevel !== null) {
                                    ...
                                    accessLevelArrayFromItem = tempItem["AccessLevel"].split(',');
                                    accessLevelArrayFromUser_2 = tempAccessLevel.split(',');
                                    accessLevelArrayFromItem.forEach(function (element) {
                            ...
                            if (tempItem.ClientCompanyNo == companyNo_1.toString() && isAccessLevelPresent) {
                                tempArray_2.push(tempItem);
                            }
                        });
                        item = tempArray_2[0];
                        if (item !== null && item !== undefined) {
                            this.setState({ companyNo: companyNo_1 });
                        }
                        else {
                            this.setState({ dataNotFound: true });
                        }
                    ...
                    case 13:
                        ...
                        this.setState({ invalidPermission: true });
                        _a.label = 14;
                    case 14: return [4 /*yield*/, this.getDueDiligenceQuestions()];
                    case 15:
                        _a.sent();
    ...
    Request8.prototype.render = function () {
        var _this = this;
                        ...
                        :
                            React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "container-xl" },
                                    React.createElement("ul", { className: "row no-gutters process-block mb-5" }, Constants.REQ8_SECTION_OPTIONS.map(function (item, i) { return (React.createElement("li", { key: i, className: i === (_this.state.currentStep - 1) ? Constants.CLSCOLACTIVE : _this.state.currentStep > i ? Constants.CLSCOLSAVE : Constants.CLSCOL },
    ...
    Request8.prototype.getEditableFields = function (item) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Request8.prototype.RenderSections = function (step) {
        ...
        switch (step) {
            case 1:
                return React.createElement(Section1, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, companyNo: this.state.companyNo, listData: this.state.listData, data: this.state.section1Data, dataChange: this.dataChange.bind(this), nextStep: this.NextStep.bind(this), listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
            case 2:
                return React.createElement(DueDiligence, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.dueDiligenceData, dataChange: this.dataChange.bind(this), nextStep: this.NextStep.bind(this), backStep: this.BackStep.bind(this), listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted }));
            case 3:
                return React.createElement(DuplicationCheck, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.DuplicationSectionData, dataChange: this.dataChange.bind(this), approvalData: this.state.approvalData, nextStep: this.NextStep.bind(this), backStep: this.BackStep.bind(this), listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
            case 4:
                return React.createElement(Section3, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section3Data, dataChange: this.dataChange.bind(this), section2Data: this.state.DuplicationSectionData, nextStep: this.NextStep.bind(this), backStep: this.BackStep.bind(this), contactCompanyNo: this.state.approvalData.contactCompanyNo, listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel, CountryOfCompany: this.state.countryOfCompany }));
            case 5:
                return React.createElement(Section4, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section4Data, dataChange: this.dataChange.bind(this), section2Data: this.state.DuplicationSectionData, approvalData: this.state.approvalData, nextStep: this.NextStep.bind(this), backStep: this.BackStep.bind(this), listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted }));
            case 6:
                return React.createElement(Attachments, __assign({}, this.props, { itemID: this.state.itemID, listData: this.state.listData, approvalData: this.state.approvalData, backStep: this.BackStep.bind(this), itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
        }
    };
    Request8.prototype.dataChange = function (id, value) {
        var _a;
        /// <summary>Method to be called to set state in request7.</summary>
        this.setState(__assign({}, this.state, (_a = {}, _a[id] = value, _a)));
    };
    Request8.prototype.NextStep = function () {
    ...
    Request8.prototype.BackStep = function () {
    ...
    Request8.prototype.getDueDiligenceQuestions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var viewXML, data, tempQuestionsArray, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        viewXML = "<View><ViewFields>\n            <FieldRef Name=\"ID\"></FieldRef>\n            <FieldRef Name=\"Question\"></FieldRef>\n            <FieldRef Name=\"Sequence\"></FieldRef>\n            <FieldRef Name=\"IsMultiSelect\"></FieldRef>\n            <FieldRef Name=\"IsRequired\"></FieldRef>\n            </ViewFields>\n            <RowLimit>4999</RowLimit>\n            <Query><Where>\n            <And>\n                <Eq><FieldRef Name=\"IsActive\"/><Value Type=\"Integer\">1</Value></Eq>\n                <Eq><FieldRef Name=\"RequestType\"/><Value Type=\"Text\">Legal Client Creation - Contact Company Conversion</Value></Eq>\n            </And>    \n          </Where>\n          <OrderBy><FieldRef Name=\"Sequence\" Ascending=\"True\" /></OrderBy>\n          </Query>\n            </View>";
                        return [4 /*yield*/, this.objWeb.getList(this.props.context.pageContext.web.serverRelativeUrl + Constants.DUEDILQUESTIONSURL).getItemsByCAMLQuery({ ViewXml: viewXML }, 'FieldValuesAsText')];
                    case 1:
                        data = _a.sent();
                        if (data) {
                            tempQuestionsArray = [];
                            for (i = 0; i < data.length; i++) {
                                tempQuestionsArray.push({
                                    key: "dpDDOptions" + i, value: data[i]["Question"], openable: true,
                                });
                            }
                            listOfEditableFields = listOfEditableFields.concat(tempQuestionsArray);
                        }
                        return [2 /*return*/];
                }
            });
...
export default Request8;
//# sourceMappingURL=Request8.js.map