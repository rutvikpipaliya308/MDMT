...
var Section1 = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        _c.label = 8;
                    case 8:
                        if (!(this.props.data !== null && this.props.data !== undefined)) return [3 /*break*/, 10];
        ...
        return (React.createElement("div", { className: "container-fluid" },
            React.createElement("div", { className: "card-primary", style: { position: "relative" } },
                ...
                React.createElement("div", { className: "card-body" },
                    React.createElement(CompanySection, __assign({ ref: this.companySectionRef }, this.props, { dpCompany: this.state.dpCompany, setLoader: this.SetLoader.bind(this), rbtnWorkflowType: this.state.rbtnWorkflowType, isDisable: this.props.itemID === 0 ? false : true, isWorkflowTypeNeeded: true, requestType: strings.RequestType[3], accessLevel: this.props.accessLevel, setCurrentCompanyAccessLevel: this.setCurrentCompanyAccessLevel, countryOfCompany: this.state.countryOfCompany })),
                    this.props.itemID === 0 && React.createElement(React.Fragment, null,
                        React.createElement("div", { className: "card-header text-center" },
    ...
    Section1.prototype.BindGridData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var viewXML, tempItems, tempArray_1, data, tempArray_2, _loop_1, this_1, item, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (data !== null) {
                            ...
                            _loop_1 = function (item) {
                                tempArray_2.push({
                                    ...
                                    ClientLead: data[item]["ClientLead"],
                                    CommercialManager: data[item]["CommercialManager"],
                                    Biller: data[item]["Biller"],
                                    ProjectAnalyst: data[item]["ProjectAnalyst"],
                                    ResourceManager: data[item]["ResourceManager"],
                                    //end
                                    //rutvik 13-3-2024
                                    LegalNameInArabic: data[item]["LegalNameInArabic"],
                                    ArabicLine1: data[item]["ArabicLine1"],
                                    ArabicLine2: data[item]["ArabicLine2"],
                                    // ArabicZipCode: data[item]["ArabicZipCode"],
                                    ArabicPostalDistrict: data[item]["ArabicPostalDistrict"],
                                    ArabicCountryAreaRegion: data[item]["ArabicCountryAreaRegion"]
                                    //end
                                });
                            };
                            this_1 = this;
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log("BindGridData(Section1.tsx)--->", error_1);
                        return [3 /*break*/, 3];
    ...
    Section1.prototype.GetSelectedSocialName = function (maconomyNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var viewXML, tempItems, tempArray_3, data, _a, _b, errors, error_2;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        this.setState({
                            ...
                            updateRequestDataArray: {
                                ...
                                //end
                                //rutvik 13-3-24
                                LegalNameInArabic: data[0]["LegalNameInArabic"],
                                ArabicLine1: data[0]["ArabicLine1"],
                                ArabicLine2: data[0]["ArabicLine2"],
                                // ArabicZipCode: data[0]["ArabicZipCode"],
                                ArabicPostalDistrict: data[0]["ArabicPostalDistrict"],
                                ArabicCountryAreaRegion: data[0]["ArabicCountryAreaRegion"]
                            }
                        });
                        return [3 /*break*/, 4];
                    case 3:
    ...
    Section1.prototype.SaveData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var accessLevel, companyNumber, tempData, queryParameters, id, currentUSerID, recordSaved, viewXML, newFolderPath, oldFolderPath, tempData2, tempArray_4, requeuestData, folderPathBody, body, tempBody, error_3, errordata;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.objWeb.getList(this.serverRelativeURL + "/Lists/" + Constants.REQUESTS_INTERNALNAME).items.getById(this.state.itemID).update(tempData).then(function (res) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!(this.props.listData !== null && this.props.listData !== undefined)) return [3 /*break*/, 2];
                                ...
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        _a.Country = _b.sent(),
                                            ...
                                            //end
                                            //rutvik 13-3-24
                                            _a.LegalNameInArabic = selectedClientData.LegalNameInArabic,
                                            _a.ArabicLine1 = selectedClientData.ArabicLine1,
                                            _a.ArabicLine2 = selectedClientData.ArabicLine2,
                                            // ArabicZipCode: selectedClientData.ArabicZipCode,
                                            _a.ArabicPostalDistrict = selectedClientData.ArabicPostalDistrict,
                                            _a.ArabicCountryAreaRegion = selectedClientData.ArabicCountryAreaRegion;
                    ...
                    case 10:
                        ...
                        tempData2.filter(function (tempItem) {
                            ...
                            if (tempItem.ID != _this.state.itemID && tempItem.MaconomyAccountID == _this.state.selectedClient.macAccountId && tempItem.Status == strings.Status[1] && (tempItem.RequestType == Constants.REQUESTTYPE_OPTIONS[1].text || tempItem.RequestType == Constants.REQUESTTYPE_OPTIONS[3].text) && isAccessLevelPresent) {
                    ...
                    case 16:
                        error_3 = _a.sent();
                        console.log("section 1 save data", error_3);
                        errordata = {
                            Title: new Date(),
                            Errors: error_3,
    ...
    Section1.prototype.CheckIsRequestExists = function () {
        return __awaiter(this, void 0, void 0, function () {
            var viewXML, tempData2, tempArray, requestData, errorsObj;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        tempData2.filter(function (tempItem) {
                            ...
                            if (tempItem.Status == strings.Status[0] && tempItem.Submitted == true && tempItem.MaconomyAccountID == _this.state.selectedClient.macAccountId && tempItem.RequestType == Constants.REQUESTTYPE_OPTIONS[3].text && isAccessLevelPresent) {
                                tempArray.push(tempItem);
                            }
                        });
