...
var Request10 = /** @class */ (function (_super) {
    __extends(Request10, _super);
    function Request10(props) {
    ...
    Request10.prototype.componentWillMount = function () {
    ...
    Request10.prototype.getEditableFields = function (item) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Request10.prototype.render = function () {
        var _this = this;
                        ...
                        :
                            React.createElement(React.Fragment, null,
                                React.createElement("div", { className: "container-xl" },
                                    React.createElement("ul", { className: "row no-gutters process-block mb-5" }, Constants.CLIENTUPDATE_SECTIONS.map(function (item, i) { return (React.createElement("li", { key: i, className: i === (_this.state.currentStep - 1) ? Constants.CLSCOLACTIVE : _this.state.currentStep > i ? Constants.CLSCOLSAVE : Constants.CLSCOL },
    ...
    Request10.prototype.RenderSections = function (step) {
        ...
        switch (step) {
            case 1:
                return React.createElement(Section1, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section1Data, dataChange: this.dataChange.bind(this), nextStep: this.NextStep.bind(this), itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
            case 2:
                return React.createElement(Section2, __assign({}, this.props, { itemID: this.state.itemID, isFHDUser: this.state.isFHDUser, listData: this.state.listData, data: this.state.section2Data, dataChange: this.dataChange.bind(this), selectedClient: this.state.approvalData.maconomyAccountID, nextStep: this.NextStep.bind(this), backStep: this.BackStep.bind(this), selectedClientData: this.state.section1Data.updateRequestDataArray, listOfEditableFields: listOfEditableFields, itemSubmitted: this.state.itemSubmitted, CountryOfCompany: this.state.countryOfCompany }));
            case 3:
                return React.createElement(Attachments, __assign({}, this.props, { itemID: this.state.itemID, listData: this.state.listData, approvalData: this.state.approvalData, backStep: this.BackStep.bind(this), requestJson: this.state.requestJson, clientJson: this.state.clientJson, itemSubmitted: this.state.itemSubmitted, accessLevel: this.state.accessLevel }));
        }
    };
    Request10.prototype.dataChange = function (id, value) {
        var _a;
        /// <summary>Method to be called to set state in request7.</summary>
        this.setState(__assign({}, this.state, (_a = {}, _a[id] = value, _a)));
    };
    Request10.prototype.NextStep = function () {
    ...
    Request10.prototype.BackStep = function () {
...
export default Request10;
//# sourceMappingURL=Request10.js.map