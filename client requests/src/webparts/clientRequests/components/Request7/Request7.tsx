...
import { IRequest7Props, IRequest7State } from './IRequest7Props';
...
export default class Request7 extends React.Component<IRequest7Props, IRequest7State> {
    ...
    constructor(props: IRequest7Props) {
        super(props);
        this.state = {
            currentStep: 0,
            loading: true,
    ...
    public render(): React.ReactElement<IRequest7Props> {
        return (
                            ...
                            <React.Fragment>
                                <div className="container-xl">
                                    <ul className="row no-gutters process-block mb-5">
                                        {Constants.REQ7_SECTION_OPTIONS.map((item, i) => (
