...
export default class Section1 extends React.Component<ISection1Props, ISection1State> {
            ...
            <div className="container-fluid">
                ...
                <div className="card-primary" style={{ position: "relative" }}>
                    ...
                    <div className="card-body">
                        <CompanySection ref={this.companySectionRef} {...this.props} dpCompany={this.state.dpCompany} setLoader={this.SetLoader.bind(this)} rbtnWorkflowType={this.state.rbtnWorkflowType} isDisable={this.props.itemID === 0 ? false : true} isWorkflowTypeNeeded={true} requestType={strings.RequestType[3]} accessLevel={this.props.accessLevel} setCurrentCompanyAccessLevel={this.setCurrentCompanyAccessLevel} countryOfCompany={this.state.countryOfCompany} />

                        {/* Display Client details in Data Table */}
                        {this.props.itemID === 0 && <React.Fragment>
            ...
            if (data !== null && data.length > 0) {
                ...
                this.setState({
                    ...
                    updateRequestDataArray: {
                        ...
                        CustomerRemark8: data[0]["CustomerRemark8"],//Shraddha test 8
        ...
        try {
            ...
            if (this.state.itemID > 0) {
                ...
                await this.objWeb.getList(this.serverRelativeURL + "/Lists/" + Constants.REQUESTS_INTERNALNAME).items.getById(this.state.itemID).update(tempData).then(async (res) => {
                    if (this.props.listData !== null && this.props.listData !== undefined) {
                        if (!queryParameters.getValue("itemID")) { //rutvik test changes
                ...
                await this.objWeb.getList(this.serverRelativeURL + "/Lists/" + Constants.REQUESTS_INTERNALNAME).items.add(tempData).then(async (res) => {
                    ...
                    let tempUpdateRequestData = {
                        ...
                        //end
                        //rutvik 13-3-24
                        LegalNameInArabic: selectedClientData.LegalNameInArabic,
                        ArabicLine1: selectedClientData.ArabicLine1,
                        ArabicLine2: selectedClientData.ArabicLine2,
                        // ArabicZipCode: selectedClientData.ArabicZipCode,
                        ArabicPostalDistrict: selectedClientData.ArabicPostalDistrict,
                        ArabicCountryAreaRegion: selectedClientData.ArabicCountryAreaRegion,
                        //end
                ...
                tempData2.filter((tempItem) => {
                    ...
                    if (tempItem.ID != this.state.itemID && tempItem.MaconomyAccountID == this.state.selectedClient.macAccountId && tempItem.Status == strings.Status[1] && (tempItem.RequestType == Constants.REQUESTTYPE_OPTIONS[1].text || tempItem.RequestType == Constants.REQUESTTYPE_OPTIONS[3].text) && isAccessLevelPresent) {
                        tempArray.push(tempItem);
                    }
                });
    ...
    private async CheckIsRequestExists() {
        ...
        tempData2.filter((tempItem) => {
            ...
            if (tempItem.Status == strings.Status[0] && tempItem.Submitted == true && tempItem.MaconomyAccountID == this.state.selectedClient.macAccountId && tempItem.RequestType == Constants.REQUESTTYPE_OPTIONS[3].text && isAccessLevelPresent) {
                tempArray.push(tempItem);
            }
        });
