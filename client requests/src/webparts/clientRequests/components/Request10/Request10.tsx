...
export default class Request10 extends React.Component<IRequest10Props, IRequest10State> {
    ...
    public render(): React.ReactElement<IRequest10Props> {
        return (
                            ...
                            <React.Fragment>
                                <div className="container-xl">
                                    <ul className="row no-gutters process-block mb-5">
                                        {Constants.CLIENTUPDATE_SECTIONS.map((item, i) => (
    ...
    private RenderSections(step: number) {
        ...
        switch (step) {
            case 1:
                return <Section1 {...this.props} itemID={this.state.itemID} isFHDUser={this.state.isFHDUser} listData={this.state.listData} data={this.state.section1Data} dataChange={this.dataChange.bind(this)} nextStep={this.NextStep.bind(this)} itemSubmitted={this.state.itemSubmitted} accessLevel={this.state.accessLevel} />;
            case 2:
                return <Section2 {...this.props} itemID={this.state.itemID} isFHDUser={this.state.isFHDUser} listData={this.state.listData} data={this.state.section2Data} dataChange={this.dataChange.bind(this)} selectedClient={this.state.approvalData.maconomyAccountID} nextStep={this.NextStep.bind(this)} backStep={this.BackStep.bind(this)} selectedClientData={this.state.section1Data.updateRequestDataArray} listOfEditableFields={listOfEditableFields} itemSubmitted={this.state.itemSubmitted} CountryOfCompany={this.state.countryOfCompany} />;
            case 3:
